<div class="relative rounded overflow-hidden"
    x-data="{ isOpen: false }"
>
    <x-input ::type="isOpen ? 'text' : 'password'" {{ $attributes }} />
