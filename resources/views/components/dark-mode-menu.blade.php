...
>
    <x-slot name="trigger">
    <x-button-ghost type="button" class="p-2!" aria-controls="dark-mode-menu" aria-label="{{ __('Toggle dark mode menu.') }}">
    ...
    >
        <x-dropdown-button type="button" class="flex items-center gap-2" aria-label="{{ __('Set light theme.') }}"
        ...
        <x-dropdown-button type="button" class="flex items-center gap-2" aria-label="{{ __('Set dark theme.') }}"
        ...
        <x-dropdown-button type="button" class="flex items-center gap-2" aria-label="{{ __('Set system theme.') }}"
