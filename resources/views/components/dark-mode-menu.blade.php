...
>
    <x-slot name="trigger">
        <x-button-ghost type="button" class="!p-2" aria-controls="dark-mode-menu" aria-label="Toggle dark mode menu.">
            <span class="dark:hidden stroke-black dark:stroke-white [&>svg]:w-5 [&>svg]:h-5 shrink-0">
            ...
            <span class="hidden dark:block stroke-black dark:stroke-white [&>svg]:w-5 [&>svg]:h-5 shrink-0">
