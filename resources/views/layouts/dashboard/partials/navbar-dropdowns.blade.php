<div class="flex gap-2">
    ...
    >
        <x-slot name="trigger">
            <x-button-ghost type="button" class="relative !p-2" aria-controls="notification-menu" aria-label="Toggle notification menu.">   
    ...
    >
        <x-slot name="trigger">
            <x-button-ghost type="button" class="!p-2" aria-controls="settings-menu" aria-label="Toggle settings menu.">
